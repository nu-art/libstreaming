...
public class H264Stream
	...
	public synchronized String getSessionDescription()
		...
		return "m=video " + String.valueOf(getDestinationPorts()[0]) + " RTP/AVP 96" + LineBreak + "a=rtpmap:96 H264/90000" + LineBreak + "a=fmtp:96 packetization-mode=1;profile-level-id=" + mConfig
				.getProfileLevel() + ";sprop-parameter-sets=" + mConfig.getB64SPS() + "," + mConfig.getB64PPS() + ";" + LineBreak;
	}
